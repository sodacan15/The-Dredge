...
const ITEMS = [
  ...
  { src: "/im_wet2.jpg",            wide: false, alt: "Flood — Before 2025",                tag: "personal",       caption: "Not the 2025 flood — one before it. The expression says everything about how this becomes ordinary. You clean the same thing twice and stop expecting it to stop. Valeza family archive." },
  // ── Assets subfolder ──
  ...
  { src: "/Assets/empyt-lot-to-upper-canumay%20part%202.jpg",  wide: false, alt: "Toward Upper Canumay (cont.)",      tag: "infrastructure", caption: "Continuation. The NLEX embankment cuts across the far distance — the canal was redirected when the highway was built. Field photograph, May 2026." },
  ...
  { src: "/Assets/nlex-east2west.jpg",                     wide: false, alt: "NLEX, East to West (Assets)",       tag: "infrastructure", caption: "East-to-west view of the NLEX embankment. The raised highway effectively severed the wetland from its upstream drainage catchment in 1966. Field photograph, May 2026." },
  ...
  { src: "/Assets/vgc-fruit-2.jpg",                        wide: false, alt: "VGC Fruit (detail)",                tag: "flora",          caption: "Close detail of the fruit cluster — possibly a species of Ficus. The tree has outlasted whatever plan someone had when they planted it. Field photograph, May 2026." },
];
