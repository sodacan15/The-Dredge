...
const ITEMS = [
  // ── Root public images ──
  { src: "/supermarket.jpg",        wide: true,  alt: "NLEX Commercial Corridor",          tag: "infrastructure", caption: "The NLEX corridor at Canumay East. Commercial buildings now occupy the landscape where the wetland and its creeks once extended. Field photograph." },
  ...
  { src: "/dalag.jpg",              wide: false, alt: "Dalag (Mudfish)",                    tag: "fauna",          caption: "Channa striata (dalag/mudfish) was confirmed by the author's grandfather as living where our house now stands. Its presence alone tells you the ecosystem was functioning. Photo: Wikimedia Commons." },
  { src: "/nlex_bridge.jpg",        wide: true,  alt: "NLEX Overpass, Canumay",             tag: "infrastructure", caption: "The NLEX overpass at Canumay was built over the exact spot where the last Kanumai tree stood. Google Street View, Apr 2025." },
  { type: "video", src: "https://www.youtube.com/embed/oexXMmxx1Q8", wide: true,  alt: "Canumay East — Field Video",         tag: "infrastructure", caption: "Field video — Canumay East. Walking through what's left." },
  ...
  { src: "/canumay-east-street.png",wide: false, alt: "Canumay East Street Corner",         tag: "infrastructure", caption: "A street corner in Canumay East — pioneer trees growing over a perforated block wall beside an 'I <3 Canumay East' marker. Persistent green through whatever gap the concrete left open." },
  ...
  { src: "/Assets/barangay-profile.jpg",                   wide: false, alt: "Barangay Profile",                  tag: "archival",       caption: "Barangay Profile Section 2.1 — the official history document listing all 7 sitios and 11 sapa. The Kanumai tree is named explicitly as the barangay's landmark." },
  { src: "/Assets/Baringtonia.jpg",                        wide: false, alt: "Baringtonia (field photo)",          tag: "flora",          caption: "Barringtonia asiatica (putat), found near the old drainage line. It still fruits despite the concrete embankment. Field photograph." },
  ...
  { src: "/Assets/emptylot.jpg",                           wide: false, alt: "Empty Lot",                         tag: "infrastructure", caption: "A vacant lot at the village edge, still seasonally flooded. The soil is dark and silty — old floodplain memory. Field photograph." },
  ...
  { src: "/Assets/empyt-lot-to-upper-canumay.jpg",         wide: true,  alt: "Toward Upper Canumay",              tag: "infrastructure", caption: "Looking from an empty lot toward Upper Canumay. The slight depression in the middle ground traces the old creek bed. Field photograph." },
  ...
  { src: "/Assets/marton-coconuts.jpg",                    wide: false, alt: "Marton Coconuts",                   tag: "flora",          caption: "Coconut palms along Marton Road. Old-growth, probably planted before the village was subdivided — their root systems still reach the old water table. Field photograph." },
  ...
  { src: "/Assets/nlex.jpg",                               wide: false, alt: "NLEX Corridor",                     tag: "infrastructure", caption: "Looking north along the NLEX right-of-way. The service road runs over what was once a seasonal flood channel draining to the Tullahan. Field photograph." },
  { src: "/Assets/nlex-east2westpart2.jpg",                wide: false, alt: "NLEX, Commercial View",             tag: "infrastructure", caption: "The NLEX corridor looking east. Commercial buildings now occupy the landscape. The 'Maganda sa Valenzuela' sign marks how much the area's identity has shifted. Field photograph." },
  { src: "/Assets/old-canal.jpg",                          wide: false, alt: "Old Canal",                         tag: "infrastructure", caption: "The old canal — the water has nowhere to go except down and in. This is the geometry of induced flooding: streets before it was raised" },
  { src: "/Assets/old-farm.jpg",                           wide: false, alt: "Old Farm",                          tag: "archival",       caption: "Old agricultural land used in the are before being turned to a truck storage — the kind of landscape Canumay East used to be before industrialization." },
  { src: "/Assets/old-mango-tree.jpg",                     wide: false, alt: "Old Mango Tree",                    tag: "flora",          caption: "The old mango at the corner of the lot — too large and too rooted to remove. It has outlasted three different households beneath it. Field photograph." },
  ...
  { src: "/Assets/vgc.jpg",                                wide: false, alt: "VGC Entrance",                      tag: "infrastructure", caption: "Valenzuela Gateway Center entrance. Field photograph." },
  { src: "/Assets/vgc-canal.jpg",                          wide: true,  alt: "VGC Canal",                         tag: "infrastructure", caption: "The canal running through VGC — water moves, but nothing lives in it." },
  { src: "/Assets/vgc-fruit.jpg",                          wide: false, alt: "VGC Fruit Tree",                    tag: "flora",          caption: "An unidentified fruiting tree inside VGC — likely planted as an ornamental, but possibly a relative of the old wetland-edge species." },
];
  ...
  return (
    <div className="page gallery-page">
      <PageHeader
        ...
        title="Gallery"
        subtitle="Field photographs and archival images, April–June 2026 — surviving plants, buried creeks, factory walls, and the margins where things still grow."
      />
      ...
      <div className="gallery-map-section">
        <div className="gallery-map-header">
          <span className="gallery-map-label">Location Map</span>
          <h3 className="gallery-map-title">Victoria Village, Canumay East</h3>
          <p className="gallery-map-sub">Valenzuela City, Metro Manila — 14°42′N 120°59′E</p>
        </div>
        <div className="gallery-map-frame">
          <iframe
            title="Victoria Village, Canumay East — OpenStreetMap"
            src="https://www.openstreetmap.org/export/embed.html?bbox=120.97217559814455%2C14.707398960868233%2C121.00135803222658%2C14.727986563571733&layer=mapnik&marker=14.717692762220%2C120.986766815185"
            className="gallery-map-embed"
            loading="lazy"
            allowFullScreen
          />
        </div>
        <a
          href="https://www.openstreetmap.org/?mlat=14.7177&mlon=120.9868#map=15/14.7177/120.9868"
          target="_blank"
          rel="noopener noreferrer"
          className="gallery-map-link"
        >
