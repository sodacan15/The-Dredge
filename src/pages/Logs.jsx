...
const LOGS = [
  {
    ...
    blocks: [
      ...
      },
      {
        type: "timeline",
        events: [
          { year: "1571", text: "Battle of Bangkusay. Spanish conquest folds Polo into Catangalan." },
          { year: "1587", text: "Tondo Conspiracy partly hatched in neighboring Tambobong (now Malabon)." },
          { year: "1623", text: "Polo formally established as independent town from Catangalan." },
          { year: "1761", text: "Polo re-established as separate municipality." },
          { year: "1887", text: "Dr. Pío Valenzuela born in Polo." },
          { year: "1898", text: "Philippine Revolution. Pío Valenzuela elected first municipal mayor." },
          { year: "1899", text: "American colonial administration begins. Slow industrialization, formal census-taking." },
          { year: "1960", text: "EO 401: Polo and Valenzuela separated. Canumay placed under Valenzuela." },
          { year: "1963", text: "Split reversed. Polo and Valenzuela reunified." },
          { year: "1966", text: "NLEX construction begins October 2. Diagonal cut physically divides Canumay." },
          { year: "1975", text: "Jurisdiction transferred to Metro Manila. Rapid industrialization begins." },
          { year: "1998", text: "RA 8526: Valenzuela granted cityhood, February 14." },
          { year: "2017", text: "RA 10958: Canumay East and Canumay West officially split." },
