...
const LOGS = [
  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        src: "/kangkong.jpg",
        caption:
          "Ipomoea aquatica (kangkong/water spinach), the plant that covered the low marsh zones of Victoria Village before the land was filled with adobe. Photo: Wikimedia Commons.",
      },
      {
        type: "image",
        src: "/soil-map.png",
  ...
  },
  {
    ...
    blocks: [
      ...
      {
        type: "quote",
        text: "He said it the way you'd say 'we used to have a dog.' Like it was just a fact. Like the fish weren't gone, just elsewhere.",
      },
      {
        type: "seg",
